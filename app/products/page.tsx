...
export const metadata:Metadata={title:'Products',description:'PLA 3D printer filament and material solutions from Ningbo Shuzhihai New Materials.',alternates:{canonical:'/products'},openGraph:{url:'/products',images:[{url:'/images/hero-composite-landscape.png',alt:'PLA Basic filament from Ningbo Shuzhihai New Materials'}]}}
